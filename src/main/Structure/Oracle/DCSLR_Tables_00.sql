...
(
	...
	-- 공지제목
	notiTitle varchar2(100) NOT NULL,
	-- 공지내용
	notiContent varchar2(500) NOT NULL,
	PRIMARY KEY (notiNo)
);
...
COMMENT ON TABLE NoticeBoard IS '새 테이블';
COMMENT ON COLUMN NoticeBoard.notiNo IS '공지글 번호';
COMMENT ON COLUMN NoticeBoard.notiTitle IS '공지제목';
COMMENT ON COLUMN NoticeBoard.notiContent IS '공지내용';
...
insert into noticeboard values('','첫번째 공지','냉무');
