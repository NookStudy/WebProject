...
<body style="background-color: #343434">
	...
	<h2 style="color: white;">갤러리</h2>
	</div>
	
	<!-- 목록 테이블 -->
	<table border="1" class="table table-dark table-borderless table-hover" style="width: 80%; margin: auto; text-align: center;">
	...
	<!-- 검색자 -->
	<form method="get">
		<table border="1" class="table table-dark table-borderless table-hover" style="width: 80%; margin: auto;">
			<tr>
	...
	<c:if test="${ id != null }">
			<td width="100" align="right"><button type="button" class="btn btn-outline-info btn-sm"
