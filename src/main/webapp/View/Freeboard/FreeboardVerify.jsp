...
<body>
	...
	<!-- 
	 ...
	 -->
	 <div class="container">
	 <div style="align-content: center; margin: auto; top: 50%;" class="col-4 ">
	<form action="../freeboard/verify.do" name="wrtieFrm" method="post" onsubmit="return validateForm(this)">
		<!--  
		...
		<div class="container align-items-center"
			...
			<table style="width: 400px;" class="table-borderless">
				...
				<tr>
					...
					onclick="location.href='../galleryboard/list.do';">목록 바로가기</button>
				</td>
				</tr>
			</table>
			</div>
