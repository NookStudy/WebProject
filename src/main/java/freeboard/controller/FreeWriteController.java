...
public class FreeWriteController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("프리 겟 세션:"+session.getAttribute("id"));
		req.getRequestDispatcher("/View/Freeboard/FreeboardWrite.jsp").forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//파일이 업로드 될 디렉토리의 물리적 경로를 얻어온다.
				...
				*/
				...
				if (mr==null) {
					AlertFunction.alertLocation(resp,"첨부 파일이 제한 용량을 초과합니다.","../freeboard/write.do");
					/*
