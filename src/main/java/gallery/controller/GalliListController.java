...
@WebServlet("/galleryboard/list.do")
public class GalliListController extends HttpServlet{
...
//		System.out.println("noitcelistcontroller line70 end:"+map.get("end").toString());
		...
		String pagingImg = BoardPage.pagingStr(totalCount,pageSize,blocPage,pageNum,"../galleryboard/list.do");
		...
		request.getRequestDispatcher("/View/Gallery/GalleryList3.jsp").forward(request,response);
	}
}
