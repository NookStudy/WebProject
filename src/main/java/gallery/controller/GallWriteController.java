...
@WebServlet("/galleryboard/write.do")
public class GallWriteController extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("/View/Gallery/GalleryWrite.jsp").forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//파일이 업로드 될 디렉토리의 물리적 경로를 얻어온다.
				...
				*/
				...
				if (mr==null) {
					AlertFunction.alertLocation(resp,"첨부 파일이 제한 용량을 초과합니다.","../galleryboard/write.do");
					/*
				...
				if (result==1) {
					...
					resp.sendRedirect("../galleryboard/list.do");
				}else {
					//실패하면 작성페이지로 다시 돌아간다.
					resp.sendRedirect("../galleryboard/write.do");
				}
			}
	}
