...
@WebServlet("/galleryboard/edit.do")
public class GallEditController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		dao.close();
		req.getRequestDispatcher("/View/Gallery/GalleryEdit.jsp").forward(req, resp);
	}
...
protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String gallno = mr.getParameter("gallno");
		...
		if(result ==1) {
			...
			resp.sendRedirect("../galleryboard/lookup.do?gallno="+gallno);
		}else {
			AlertFunction.alertLocation(resp, "비밀번호 검증을 다시 진행해주세요","../galleryboard/lookup.do?gallno="+gallno);
		}
	}
}
